       ...
       <table id="datatablesSimple">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td><a href="post_edit_form.php?id=<?= $row['id'] ?>" class="btn btn-outline-primary"><i class="fa-solid fa-pen-to-square"></i></a>
            <a href="post_detail.php?id=<?= $row['id'] ?>" class="btn btn-outline-primary"><i class="fa-solid fa-eye"></i></a>
